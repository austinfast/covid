...
The Howard Center combined four datasets to determine which counties nationwide might have the biggest problem protecting people experiencing homelessness. These 42 counties of highest concern represent 14 states from Hawaii to New York, and include 10 rural counties, 13 suburban counties, 6 urban counties, and 18 of the 50 largest cities in the country. The selected counties possess all the following characteristics:
...
Keeping an eye on the day-to-day fluctuations in these three data sources ([CDC](https://public.flourish.studio/visualisation/2895339/), [Johns Hopkins](https://public.flourish.studio/visualisation/2701246/), [Carnegie Mellon](https://public.flourish.studio/visualisation/2701137/)) will help the Howard Center identify Covid-19's effect in these 42 counties and where to focus our reporting efforts throughout this investigation. 
