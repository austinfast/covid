...
* High rates of homelessness per capita (according to CoC population totals imputed using an R program [supplied by a Boston University researcher](https://github.com/tomhbyrne/HUD-CoC-Geography-Crosswalk));
...
I used Jenks natural break classification to establish the thresholds to filter the data.
```{r include=FALSE}
